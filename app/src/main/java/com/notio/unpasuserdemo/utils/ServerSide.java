...
class ServerSide {
    static final String POST_TUJUAN_PENGUMUMAN = "http://122.248.39.157/unpas/pengumuman/get_list_tujuan";
    static final String GET_NAMAUUID = "http://122.248.39.157/unpas/mahasiswa/get_uuid";
